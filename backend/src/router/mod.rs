...
use crate::{
    ...
    types::{
        config::AppState,
        dto::{
            AssignEngineerRequest, AssignEngineerResponse, CurrentTaskResponse, GetRouteRequest,
            GetRouteResponse,
        },
        enums::UserRole,
...
pub async fn assign_engineer(
    ...
    let new_task = Task {
        ...
        task_route: serde_json::to_string(&final_route).expect("route is always serializable"),
        is_accepted: false,
        is_active: true,
    };
