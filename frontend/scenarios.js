...
const DemoScenarios = (() => {
  ...
  // Слоты команды в каждом сценарии: [инспектор, инспектор, авиатехник, авионика, двигатель]
  const SKILL = {
  ...
  function returnToScenarioSwitcher() {
    // «Сменить роль»: сброс JWT и возврат в тот же сценарий для переключения людей
