...
Скопируйте пример конфигурации и задайте `jwt_secret`:

На MacOS/Linux
```bash
cp .env.example .env
```
Если вы на Windows, создайте файл .env в корневой директории проекта и заполните по примеру из .env.example
